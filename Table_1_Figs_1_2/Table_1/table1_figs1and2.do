*** Stata do-file to run regressions for Table 1 and make Figures 1 and 2
set trace off
set more 1 
capture log close
clear
...
sort gapus
gr7 mv14_upspd mv14_upspdfit gapus, c(.l) s([year].)   ylab(-.006(.002).008) xlab(-.05(.01).04) b2("Ln(US Employment/Trend Employment)") b1("") l1("Detrended Migration 14+") l2("(Fraction of Population 14+)") key1("") saving(g1, replace)
* middle panel of Figure 2
replace ur12 = ur12*100
sort ur12
gr7 mv14_upspd mv14_upspdfit2 ur12, c(.l) s([year].)   ylab(-.006(.002).008) xlab(3(1)10) b2("Unemployment Rate") b1("") l1("Detrended Migration 14+") l2("(Fraction of Population 14+)") key1("") saving(g2, replace)
* bottom panel of Figure 2
replace urateus1 = urateus1*100
sort urateus1
gr7 mv14_upspd mv14_upspdfit3 urateus1, c(.l) s([year].)   ylab(-.006(.002).008) xlab(6(3)24) b2("UI Claims Rate") b1("") l1("Detrended Migration 14+") l2("(Fraction of Population 14+)") key1("") saving(g3, replace)
* Appendix Figure 1
